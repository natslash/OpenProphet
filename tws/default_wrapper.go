...
func (w *DefaultWrapper) MarketDataType(reqId int64, marketDataType int) {}
...
func (w *DefaultWrapper) UpdatePortfolio(contract Contract, position decimal.Decimal, marketPrice, marketValue, averageCost, unrealizedPNL, realizedPNL float64, accountName string) {}
func (w *DefaultWrapper) AccountDownloadEnd(accountName string) {}
